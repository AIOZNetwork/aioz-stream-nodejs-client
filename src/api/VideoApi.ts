...
export default class VideoApi {
   ...
   * @param input input
   */
  public async update(id: string, input: UpdateVideoInfoRequest = {}): Promise<ResponseSuccess > {
   ...
   */
  public async uploadThumbnail(id: string, file: string | Readable | Buffer): Promise<ResponseSuccess > {
   ...
   * @param file VTT File
   */
  public async createCaption(id: string, lan: string, file: string | Readable | Buffer): Promise<CreateVideoCaptionResponse > {
   ...
   * @param lan Language
   */
  public async deleteCaption(id: string, lan: string): Promise<ResponseSuccess > {
   ...
   */
  public async getCaptions(args: { id: string, offset?: number, limit?: number }): Promise<GetVideoCaptionsResponse > {
   ...
   */
  public async getCost(qualities: string, duration: number): Promise<GetTranscodeCostResponse > {
   ...
   * @param request video&#39;s info
   */
  public async getVideoList(request: GetVideoListRequest = {}): Promise<GetVideoListResponse > {
   ...
   */
  public async getVideoPlayerInfo(args: { id: string, token?: string }): Promise<GetVideoPlayerInfoResponse > {
   ...
   * @param lan Language
   */
  public async setDefaultCaption(id: string, lan: string): Promise<ResponseSuccess > {
   ...
   */
  public createUploadPartProgressiveSession(id: string, hash?: string, index?: string): ProgressiveSession<ResponseSuccess> {
   ...
   * @param index Index of the part
   */
  public async uploadPart(id: string, file: string, hash?: string, index?: string, progressListener?: (event: UploadProgressEvent) => void): Promise<ResponseSuccess > {
