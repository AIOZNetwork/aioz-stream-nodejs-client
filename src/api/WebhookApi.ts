...
export default class WebhookApi {
   ...
   */
  public async create(request: CreateWebhookRequest = {}): Promise<CreateWebhookResponse > {
   ...
   */
  public async update(id: string, request: UpdateWebhookRequest = {}): Promise<ResponseSuccess > {
...
You can filter what the webhook list that the API returns using the parameters described below.
   ...
   */
  public async list(args: { search?: string, sortBy?: 'created_at' | 'name', orderBy?: 'asc' | 'desc', offset?: number, limit?: number, encodingFinished?: boolean, encodingStarted?: boolean, fileReceived?: boolean } = {}): Promise<GetWebhooksListResponse > {
