...
export default class PlayersApi {
   ...
   */
  public async create(request: CreatePlayerThemeRequest = {}): Promise<CreatePlayerThemesResponse > {
   ...
   */
  public async update(id: string, input: UpdatePlayerThemeRequest = {}): Promise<UpdatePlayerThemeResponse > {
   ...
   */
  public async list(args: { search?: string, sortBy?: 'created_at' | 'name', orderBy?: 'asc' | 'desc', offset?: number, limit?: number } = {}): Promise<GetPlayerThemeResponse > {
   ...
   */
  public async uploadLogo(id: string, file: string | Readable | Buffer, link: string): Promise<UploadLogoByIdResponse > {
   ...
   */
  public async addPlayer(request: AddPlayerThemesToVideoRequest = {}): Promise<ResponseSuccess > {
   ...
   */
  public async removePlayer(request: RemovePlayerThemesFromVideoRequest = {}): Promise<ResponseSuccess > {
